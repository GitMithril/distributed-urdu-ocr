...
def build_ocr_model_kaggle(
    ...
    """
    Build the ConvTransformerOCR model and automatically wrap it in nn.DataParallel
    if multiple GPUs are detected (e.g., Kaggle T4 x2).
    """
